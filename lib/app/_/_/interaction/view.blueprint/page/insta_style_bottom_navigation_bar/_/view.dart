          ...
          items: [
            ...
            BottomNavigationBarItem(
              ...
              icon: SvgPicture.asset(
                'assets/view/insta_style_bottom_navigation_bar/check-circle-svgrepo-com.svg',
              ).opacity(0.5),
              activeIcon: SvgPicture.asset(
                  'assets/view/insta_style_bottom_navigation_bar/check-circle-svgrepo-com-fill.svg'),
            ),
            BottomNavigationBarItem(
              label: 'Places',
              icon: Icon(
            ...
            BottomNavigationBarItem(
              ...
              icon: CircleAvatar(
                radius: 11,
                backgroundImage:
                AssetImage('assets/view/insta_style_bottom_navigation_bar/iu.webp'),
              ),
                ...
                child: CircleAvatar(
                  ...
                  child: CircleAvatar(
                    ...
                    backgroundImage: AssetImage(
                        'assets/view/insta_style_bottom_navigation_bar/iu.webp'),
                  ),
                ),
              ),
            ),
